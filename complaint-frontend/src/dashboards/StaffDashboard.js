...
const StaffDashboard = () => {
  ...
  const fetchAssignments = useCallback(async () => {
    try {
      const res = await axios.get(`https://complaintsystem-sius.onrender.com/api/assignments/staff/${staffId}`, getAuthHeaders());
  ...
  const resolveComplaint = async (id) => {
    try {
      await axios.patch(`https://complaintsystem-sius.onrender.com/api/complaints/${id}/resolve`, {}, getAuthHeaders());
      fetchAssignments();
    } catch (err) {
